...
//        NSNumber *number = temp[i];
        ...
        if (isRain) {
//            ele_white_cloud_0
            cloudImage = [self imageNamed:[NSString stringWithFormat:@"ele_white_cloud_%d.png",i] withTintColor:UIColorFromRGB(0, 51, 86)];
        }else{
            cloudImage = [UIImage imageNamed:[NSString stringWithFormat:@"ele_white_cloud_%d.png",i]];
        }
        
        cloudImage = [UIImage imageNamed:@"ele_white_cloud_1.png"];
